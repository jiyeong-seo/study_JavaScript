 ...
 *모든 문자열 변수는 string클래스가 제공하는 프로퍼티와 메소드를 상속받는다
 --> 문자열 변수 안에서 특정 정보를 추출하거나 반환하는 기능
 --> 문자열 파싱
 */
...
//파라미터로 전달된 내용이 처음 나타나는 위치를 인덱스 번호로 리턴한다.
